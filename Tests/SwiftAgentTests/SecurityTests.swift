...
struct PatternMatchingTests {
    ...
    func testToolNameWildcard() {
        let rule = PermissionRule("remote__6_github__*")
        let context1 = ToolContext(toolName: "remote__6_github__list_repos", arguments: "{}")
        let context2 = ToolContext(toolName: "remote__6_github__create_pr", arguments: "{}")
        let context3 = ToolContext(toolName: "remote__5_slack__send", arguments: "{}")
